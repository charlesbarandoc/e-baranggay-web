...
<nav id="navbar" class="fixed w-full z-50 transition-all duration-300 nav-default">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <div class="flex items-center space-x-2">
            <div class="w-10 h-10 bg-red-700 rounded-full flex items-center justify-center text-white font-bold shadow-lg">BM</div>
...
<section id="home" class="relative h-screen flex items-center justify-center overflow-hidden">
    ...
    <div class="container mx-auto px-4 z-10 text-center text-white mt-16">
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="#contact" class="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/30 text-white rounded-lg font-bold transition-all flex items-center justify-center gap-2">
                <i data-lucide="phone"></i> Contact Us
            </a>
        </div>
    </div>
</section>
                    ...
                    <div class="p-6 flex flex-col flex-grow">
                        <div class="flex justify-between items-center mb-4">
                            <span class="text-xs font-bold text-slate-400 flex items-center">
                                <i data-lucide="calendar" class="w-3 h-3 mr-1"></i> <?php echo htmlspecialchars($item['date']); ?>
                            </span>
                            <?php if ($item['urgent']): ?>
                                <span class="bg-red-100 text-red-700 text-xs px-2 py-1 rounded-full font-bold animate-pulse">ALERT</span>
                            <?php endif; ?>
                        </div>
                        <h4 class="font-bold text-lg mb-2 text-slate-800 leading-tight"><?php echo htmlspecialchars($item['title']); ?></h4>
                        <p class="text-slate-500 text-sm mb-4 flex-grow"><?php echo htmlspecialchars($item['excerpt']); ?></p>
